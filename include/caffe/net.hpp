...
// My flag about to stop the data fetching from data layer
bool flag_fetch_batch_net;
void pass_flag_fetch(){
		layers_[0]->flag_fetch_batch = flag_fetch_batch_net;
/*
	for (int ii=0;ii<layers_.size();++ii){
		layers_[ii]->flag_fetch_batch = flag_fetch_batch_net;
	}
*/
}
